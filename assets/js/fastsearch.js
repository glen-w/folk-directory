...
const renderResults = (results, { emptyQuery = false } = {}) => {
    if (!Array.isArray(results) || results.length === 0) {
        resList.innerHTML = emptyQuery
            ? ""
            : '<li class="search-empty">No matches — try a county or <a href="/submit/">Submit a listing</a>.</li>';
